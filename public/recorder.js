// public/recorder.js
// Robust MediaRecorder‑klient för Kids‑BN – spelar in, begränsar till 60s och POST -> /api/whisper_transcribe
(() => {
  ...
  useBtn.addEventListener('click', () => {
    ...
    // Sätt transkriptet i promptfältet
  ...
  // Feature: disable if no MediaDevices
