...
// Returnerar 404 om inte hittat, eller streamer objektet med Content-Type och Cache-Control.
...
export async function onRequest(context) {
  ...
  try {
    ...
    if (!env.BN_AUDIO) {
      return new Response('R2 binding BN_AUDIO not configured', { status:500, headers: CORS_HEADERS });
    }
