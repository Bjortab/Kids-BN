...
export async function onRequestPost(context) {
  ...
  // Normalize age range to handle "3-4 år", "3–4 år", "3-4" etc.
  ...
  const system = [
    ...
    `Målgrupp: ${rawAgeRange || ageRange}. Ton: ${tone}. Längd: cirka ${words} ord.`,
...
function normalizeAge(value) {
  // Remove "år", replace en-dash/em-dash with hyphen, trim whitespace
  return (value || "")
    .toString()
    .toLowerCase()
    .replace(/\s*år\s*/gi, "")
